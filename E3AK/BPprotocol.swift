...
class BPprotocol{
    ...
    public func setUserAdd(Password:[UInt8], ID:[UInt8], KeypadUnlock:UInt8, limitType:UInt8) -> Data{
        
        let cmdData:[UInt8] = Password + ID + [KeypadUnlock] + [limitType]
